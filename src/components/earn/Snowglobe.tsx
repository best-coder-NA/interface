...
import { StakingInfo } from '../../state/stake/snowglobehooks'
...
export default function Snowglobe({ stakingInfo }: { stakingInfo: StakingInfo }) {
	...
	return (
		<Wrapper showBackground={isStaking} bgColor={backgroundColor}>
			...
			<TopSection>
				...
				<StyledInternalLink to={`/snowglobe/${currencyId(currency0)}/${currencyId(currency1)}`} style={{ width: '100%' }}>
